...
func installerSearchlightDev_grafanaoperatorsYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "installer.searchlight.dev_grafanaoperators.yaml", size: 60083, mode: os.FileMode(420), modTime: time.Unix(1573722179, 0)}
