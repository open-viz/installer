...
import (
	...
	"go.searchlight.dev/installer/apis/installer/fuzzer"
...
func TestPruneTypes(t *testing.T) {
	...
	// CRD v1
	if crd := (v1alpha1.GrafanaOperator{}).CustomResourceDefinition(); crd.V1 != nil {
		crdfuzz.SchemaFuzzTestForV1CRD(t, clientsetscheme.Scheme, crd.V1, fuzzer.Funcs)
	}

	// CRD v1beta1
	if crd := (v1alpha1.GrafanaOperator{}).CustomResourceDefinition(); crd.V1beta1 != nil {
