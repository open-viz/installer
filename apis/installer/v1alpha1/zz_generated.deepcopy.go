...
func (in *Alertmanager) DeepCopyInto(out *Alertmanager) {
	*out = *in
	out.ConfigSelector = in.ConfigSelector
	out.Email = in.Email
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlertmanagerConfigSelector) DeepCopyInto(out *AlertmanagerConfigSelector) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlertmanagerConfigSelector.
func (in *AlertmanagerConfigSelector) DeepCopy() *AlertmanagerConfigSelector {
	if in == nil {
		return nil
	}
	out := new(AlertmanagerConfigSelector)
	in.DeepCopyInto(out)
	return out
}
