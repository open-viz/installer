...
$ helm repo update
$ helm search repo appscode/trickster --version=v2024.9.30
$ helm upgrade -i trickster appscode/trickster -n kubeops --create-namespace --version=v2024.9.30
```
...
```bash
$ helm upgrade -i trickster appscode/trickster -n kubeops --create-namespace --version=v2024.9.30 --set replicaCount=1
```
...
```bash
$ helm upgrade -i trickster appscode/trickster -n kubeops --create-namespace --version=v2024.9.30 --values values.yaml
```
