...
locals {
  searchlight_release_name = "grafana-operator"
  searchlight_namespace    = "openviz"
}

locals {
  searchlight_chart_name = "grafana-operator"

  # re-implement: https://github.com/searchlight/grafana-operator/blob/0.3.0/charts/grafana-operator/templates/_helpers.tpl#L9-L20
  # in hcl
