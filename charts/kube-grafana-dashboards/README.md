...
$ helm repo update
$ helm search repo appscode/kube-grafana-dashboards --version=v2022.04.04
$ helm upgrade -i kube-grafana-dashboards appscode/kube-grafana-dashboards -n kubeops --create-namespace --version=v2022.04.04
```
...
```bash
$ helm upgrade -i kube-grafana-dashboards appscode/kube-grafana-dashboards -n kubeops --create-namespace --version=v2022.04.04 --set dashboard.folderID=0
```
...
```bash
$ helm upgrade -i kube-grafana-dashboards appscode/kube-grafana-dashboards -n kubeops --create-namespace --version=v2022.04.04 --values values.yaml
```
