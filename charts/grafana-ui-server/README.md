...
$ helm repo update
$ helm search repo appscode/grafana-ui-server --version=v0.0.2
$ helm upgrade -i grafana-ui-server appscode/grafana-ui-server -n kubeops --create-namespace --version=v0.0.2
```
...
```bash
$ helm upgrade -i grafana-ui-server appscode/grafana-ui-server -n kubeops --create-namespace --version=v0.0.2 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana-ui-server appscode/grafana-ui-server -n kubeops --create-namespace --version=v0.0.2 --values values.yaml
```
