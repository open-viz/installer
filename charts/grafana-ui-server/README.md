...
$ helm repo update
$ helm search repo appscode/grafana-ui-server --version=v2022.04.04
$ helm upgrade -i grafana-ui-server appscode/grafana-ui-server -n kubeops --create-namespace --version=v2022.04.04
```
...
```bash
$ helm upgrade -i grafana-ui-server appscode/grafana-ui-server -n kubeops --create-namespace --version=v2022.04.04 --set replicaCount=1
```
...
```bash
$ helm upgrade -i grafana-ui-server appscode/grafana-ui-server -n kubeops --create-namespace --version=v2022.04.04 --values values.yaml
```
